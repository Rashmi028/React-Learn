...
function App() {
  ...
  const passwordGenerator=useCallback(() =>{
    let pass=""
    let str="ABCDEFGHIJKLMNOPQRSTUVWWXYZabcdefghijklmnopqrstuvwxuz"
  ...
  const copyPasswordToClipboard= useCallback(()=> {
   ...
   window.navigator.clipboard.writeText(password) //copy the password and pasting in clipboard
  },[password])
  ...
  return (
     <div className='w-full  max-w-md mx-auto shadow-md rounded-lg px-4 py-3 my-8 bg-gray-800 text-orange-50'>
      ...
      <div className='flex text-sm fap-x-2'>
